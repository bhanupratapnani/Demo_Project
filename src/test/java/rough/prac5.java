...
public class prac5 {
	    ...
	    public void test() throws InterruptedException, IOException {
	        ...
	        int rowNum = 1; // For Excel row tracking
	        ...
	        String[] photoPaths = {"A.jpg", "B.jpg", "C.png", "D.jpg", "E.png"};
	            ...
	            for (String msg : messages) {
	                ...
	                WebElement messageBox = driver.findElement(By.id("replyBox")); // Change as needed
	            ...
	            for (String file : filePaths) {
	                ...
	                WebElement fileUpload = driver.findElement(By.xpath("//input[@type='file']")); // Change as needed
	            ...
	            for (String photo : photoPaths) {
	                ...
	                WebElement photoUpload = driver.findElement(By.xpath("//input[@type='file']")); // Change as needed
	        ...
	        // Write to Excel file
	        FileOutputStream out = new FileOutputStream("MessageSendLog.xlsx");
	        workbook.write(out);
	        out.close();
	        workbook.close();
